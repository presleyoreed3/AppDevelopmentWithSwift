...
func introduceMyself(firstName: String, lastName: String){
    print ("Hello my names is \(firstName) \(lastName)")
}
introduceMyself(firstName: "Presley", lastName: "Reed III")
...
func magicEightBall(randomNum: UInt32){
        switch randomNum {
    case 0,2,4:
...
magicEightBall(randomNum: arc4random_uniform(UInt32(5)))
